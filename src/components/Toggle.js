...
const Toggle = ({ children, title }) => {
	...
	return (
		<motion.div
			layout
			className="w-full font-['Poppins'] font-[500] text-[17px] text-gray-900 tracking-tight pointer-cursor border my-6 py-6 px-6 bg-gray-200"
			...
			<div className='flex justify-between mb-4 cursor-pointer'>
				<div className='flex items-center'>
					...
					<motion.h4
						layout
						className="font-['Poppins'] font-[500] text-[17px] text-gray-500 tracking-tight">
						{title}
					</motion.h4>
				</div>
